...
<Switch>
<Redirect exact from="/customer-page/customer-content" to={"/customer-page/customer-content/add-customer-page" + this.props.location.search}/>
<Route
  exact
  path="/customer-page/customer-content/add-customer-page"
  component={
  withAuth(AddCustomerPageComponent
  )
...
<Route
  ...
  component={
  withAuth(ListCustomerPageComponent
  )
...
<Route
  ...
  component={
  withAuth(DetailCustomerPageComponent
  )
...
<Route
  ...
  component={
  withAuth(CreateAccountPageComponent
  )
