    ...
    def build_interaction_flow(self, selectedSchema):
        ...
        for int_flow_element in list_interaction_flows:
            ...
            if instance == NavigationFlow.NAVIGATION_FLOW_TYPE:
                nav_flow = NavigationFlow(int_flow_element, self.uml_symbol_table, self.ifml_symbol_table)
                dict_interaction_flows.update({nav_flow.get_id(): nav_flow})

            # If it's data flow
            elif instance == DataFlow.DATA_FLOW_TYPE:
                data_flow = DataFlow(int_flow_element, self.uml_symbol_table, self.ifml_symbol_table)
            ...
            # If it's interaction flow
                ...
                int_flow_instance = InteractionFlow(int_flow_element, self.uml_symbol_table, self.ifml_symbol_table)
